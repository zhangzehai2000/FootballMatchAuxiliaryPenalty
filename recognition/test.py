...
def setOPT(**params):
    ...
    parser.add_argument('--weights', type=str, default="D:\\pythonLearn\\face-net\\weights\\face_last.pt", help='model.pt path')
    #parser.add_argument('--source', type=str, default='D:\\pythonLearn\\face-net\\test\\testDatasets1', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source', type=str, default="D:\\基于计算机视觉的足球比赛辅助判罚系统的设计与实现\\英超球队\\test.mp4", help='source')
    parser.add_argument('--output', type=str, default='D:\\pythonLearn\\face-net\\test\\output', help='output folder')  # output folder
    ...
    parser.add_argument('--facenet-model-path',type=str,default='D:\\pythonLearn\\face-net\\resouces\\20180402-114759\\20180402-114759.pb',help='miss facenet-model')
...
if __name__ == "__main__":
    ...
    # weights = 'D:/py/FaceRecognition/weights/face_last.pt'    #yolov5权重
    # output = '../inference/output'    #输出文件保存位置
    # source = "D:/py/FaceRecognition/inference/images/0.jpg"   #输入检测文件
    # source = "C:/Users/Desktop/26321934-1-192.mp4"  # 输入检测文件
