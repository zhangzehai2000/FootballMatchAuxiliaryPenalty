...
```shell
python yolov5_utils/loggers/comet/hpo.py \
...
```shell
comet optimizer -j <set number of workers> yolov5_utils/loggers/comet/hpo.py \
  yolov5_utils/loggers/comet/optimizer_config.json"
```
