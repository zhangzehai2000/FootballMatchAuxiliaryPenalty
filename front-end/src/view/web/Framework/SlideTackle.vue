          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测结果" name="first">
              ...
              <el-table
                ...
                lazy
              >
                <el-table-column label="目标类别" width="750px">
                  <template slot-scope="scope">
<!--                    <span>{{ scope.row[2] }}</span>-->
                    <span  v-if="scope.row[2]=='falling'">铲球犯规</span>
                    <span  v-if="scope.row[2]=='falling-02'">铲球犯规</span>
                    <span  v-if="scope.row[2]=='falling-03'">铲球犯规</span>
<!--                    <span  v-else-if="scope.row[2]!='falling'">无犯规</span>-->
                  </template>
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    update(e) {
      ...
      axios
        .post(this.server_url + "/home/slideTackle/upload", param, config)
        .then((response) => {
          this.percentage = 100;
          clearInterval(timer);
