          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测结果" name="first">
              ...
              >
                <el-table-column label="目标类别" width="375px">
                  <template>
                    <span>{{ this.labels }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="置信度" width="375px">
                  <template>
                    <span>{{ this.confidence_level }}</span>
                  </template>
                </el-table-column>
              </el-table>
...
export default {
  ...
  methods: {
    ...
    update(e) {
      ...
      axios
        .post(this.server_url + "/home/premierLeague/upload", param, config)
        .then((response) => {
          this.percentage = 100;
          clearInterval(timer);
          ...
          this.labels_list = [1];
          this.confidence_level = response.data.confidence_level
